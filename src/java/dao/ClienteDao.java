...
public class ClienteDao {
	...
	public static Cliente updateUser(String dni, String nombre, String apellidos, String fechanac, String sexo,
            ...
            log.info("updateUser()..............." + dni + "\t" + nombre + "\t" + apellidos
            + "\t" + fechanac + "\t" + sexo + "\t" + direccion + "\t" + telefono );
		Cliente c = new Cliente();
		c.setValid(false);
        ...
        public static Cliente loginReg(String dni, String nombre, String apellidos, String fechanac, String sexo, String direccion, String telefono, String pass) {
            ...
            log.info("loginReg()..............." + dni + "\t" + nombre + "\t" + apellidos
            + "\t" + fechanac + "\t" + sexo + "\t" + direccion + "\t" + telefono + "\t" + pass);
	Cliente c = new Cliente();
        c.setValid(false);
	...
	try {
		...
		stat.executeUpdate();
            ...
            log.error("loginReg()................ERROR "+e.getMessage());
		System.err.println(e.getMessage());
		e.printStackTrace();
	} catch (IOException e) {
		// TODO Auto-generated catch block
