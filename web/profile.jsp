...
<body>
	...
	<ul>
		<li>Sesión: <%=dni%></li>
		<li><a href="LogoutServlet" class="button">Logout</a></li>
		<li><form>
	...
	<div class="box2">
		<form action="UpdateServlet" method="post">
			...
			<div class="6u 12u(3)">
				Nombre: <input type="text" value="<%=c.getNombre()%>" name="nombre"></input>

				Apellidos: <input type="text" value="<%=c.getApellidos()%>"
				...
				Dirección: <input type="text" value="<%=c.getDireccion()%>"
			...
			<div class="6u 12u(3)">
				<input type="submit" value="Actualizar"></input>
                        ...
                        <div class="6u 12u(3)">
                            <a href="ServletListAccount?dni=<%=dni%>" class="button">Cuentas</a>
			</div>
